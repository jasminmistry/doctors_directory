  ...
  await processAll('treatments', allNames, async (name) => {
    ...
    const record = await prisma.treatment.upsert({
      ...
      create: {
        ...
        goals:             content.goals             ?? Prisma.JsonNull,
        prosAndCons:       content.prosAndCons       ?? Prisma.JsonNull,
        cost:              content.cost              ?? Prisma.JsonNull,
        choosingDoctor:    content.choosingDoctor    ?? Prisma.JsonNull,
        alternatives:      content.alternatives      ?? Prisma.JsonNull,
        goodCandidate:     content.goodCandidate     ?? Prisma.JsonNull,
        preparation:       content.preparation       ?? Prisma.JsonNull,
        safetyAndPain:     content.safetyAndPain     ?? Prisma.JsonNull,
        howLongResultsLast:content.howLongResultsLast ?? Prisma.JsonNull,
        mildVsSevere:      content.mildVsSevere      ?? Prisma.JsonNull,
        whatHappensDuring: content.whatHappensDuring ?? Prisma.JsonNull,
        recovery:          content.recovery          ?? Prisma.JsonNull,
        regulation:        content.regulation        ?? Prisma.JsonNull,
        maintenance:       content.maintenance       ?? Prisma.JsonNull,
        qualifications:    content.qualifications    ?? Prisma.JsonNull,
        niceGuidelines:    content.niceGuidelines    ?? Prisma.JsonNull,
      },
      update: {
        description:       extractDescriptionText(rawDesc),
        goals:             content.goals             ?? Prisma.JsonNull,
  ...
  await processAll('clinics', rows, async (clinic) => {
    ...
    const record = await prisma.clinic.upsert({
      ...
      create: {
        ...
        reviewAnalysis:   clinic.reviewAnalysis   ?? Prisma.JsonNull,
        weightedAnalysis: clinic.weighted_analysis ?? Prisma.JsonNull,
        criteriaBreakdown: clinic.criteria_breakdown ?? Prisma.JsonNull,
        advice:            clinic.advice           ?? Prisma.JsonNull,
      },
      update: {},
    })
  ...
  await processAll('practitioners', rows, async (p) => {
    ...
    const record = await prisma.practitioner.upsert({
      ...
      create: {
        ...
        weightedAnalysis: p.weighted_analysis ?? Prisma.JsonNull,
      },
      update: {},
    })
  ...
  await processAll('products', rows, async (prod) => {
    ...
    await prisma.product.upsert({
      ...
      create: {
        ...
        allPrices:           prod.all_prices ?? Prisma.JsonNull,
      },
      update: {},
    })
  })
