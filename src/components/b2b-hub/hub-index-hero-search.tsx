...
export function HubIndexHeroSearch({
  ...
  return (
    <section className="bg-[#F2EEE6] px-4 pt-12 pb-10 md:pb-14">
      <div className="max-w-[1280px] mx-auto text-center">
        <h1 className={heroTitleClassName}>{heroTitle}</h1>
        {heroSubtitle ? (
          <p className="text-neutral-600 text-lg max-w-3xl mx-auto mb-10 leading-relaxed">
            {heroSubtitle}
          </p>
        ) : null}
        <div className="flex flex-col sm:flex-row gap-3 max-w-3xl mx-auto items-stretch sm:items-center justify-center">
