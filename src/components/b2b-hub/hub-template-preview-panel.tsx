    ...
    <div className="flex h-full min-h-[420px] flex-col overflow-hidden rounded-2xl border border-[#e0e0e0] bg-white shadow-sm lg:min-h-0">
      ...
      >
        <div className="relative flex h-full w-full flex-1 flex-col overflow-hidden rounded-lg border border-[#d4ccc0] bg-white shadow-[0_12px_40px_rgba(0,0,0,0.12)] lg:max-w-none">
          <div className="border-b border-[#EDE9E3] bg-[#fbfbfb] px-4 py-3">
          ...
          <div className="flex flex-1 flex-col gap-2.5 p-4">
            ...
            <div className="mt-auto grid grid-cols-2 gap-2 pt-4">
              <div className="h-8 rounded border border-[#e0e0e0] bg-white" />
      ...
      <p className="border-t border-[#e0e0e0] px-5 py-3 text-center text-sm text-[#6B6B6B]">
        Preview — {title}
      </p>
    </div>
  )
