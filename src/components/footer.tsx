...
const FOOTER_COLUMN_HEADING =
  "font-medium text-base leading-7 text-grey font-inter mb-2";
const FOOTER_WP_LINK =
  "block text-sm leading-6 text-black hover:opacity-70 transition";
...
export function Footer() {
  ...
  return (
    <>
      ...
      >
        <div className="bg-[var(--primary-bg-color)] mb-10 py-10">
          <div className="mx-auto max-w-7xl px-6 flex flex-col items-center justify-between md:flex-row">
            <div className="w-full md:w-auto">
              <section className="mb-2 text-lg font-medium md:text-2xl">
              ...
              <a
                ...
                className={
                  isBusinessHub
                    ...
                    : "w-full h-auto sm:w-auto inline-flex items-center justify-center gap-2 rounded-lg bg-black px-6 py-3 text-base font-medium text-white hover:bg-neutral-800 transition-colors"
                }
              >
                Book Demo
              </a>
        ...
        <div className="mx-auto max-w-7xl px-6">
            ...
            <div>
              <div>
                <img
                  ...
                  className="mb-6"
                />
                <p className="text-sm font-normal leading-6 text-gray-600 mb-8">
              ...
              <div className="space-y-1 text-sm">
                <p className="flex items-center gap-2">
                  <Phone className="h-5 w-5 shrink-0 text-black" aria-hidden />
                ...
                <p className="flex items-center gap-2">
                  <Mail className="h-5 w-5 shrink-0 text-black" aria-hidden />
                  <a
          ...
          <div className="my-6 border-t border-black/10 md:my-8" />
      ...
      <div className="b-footer border-t border-black/10 bg-white py-4">
        <div className="mx-auto max-w-7xl px-6">
          <div className="grid grid-cols-1 items-center gap-4 text-sm text-black md:grid-cols-2">
