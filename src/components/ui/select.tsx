  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <IconChevronDown stroke={1.5} className="size-4 opacity-50" />
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <IconChevronUp stroke={1.5} className="size-4" />
    </SelectPrimitive.ScrollUpButton>
  )
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <IconChevronDown stroke={1.5} className="size-4" />
    </SelectPrimitive.ScrollDownButton>
  )
}
