...
export const CONSENT_FORM_VERSION = 'v2'

export const TERMS_URL =
  `${process.env.NEXT_PUBLIC_MARKETING_BASE_URL || 'https://www.consentz.com'}/terms/`
...
export function consentCheckboxWording(clinicName: string): ConsentCheckboxWording {
  return {
    ...
    terms: `I have read and agree to the Consentz Terms & Conditions, available at ${TERMS_URL}.`,
  }
}
